        ...
        <div className="plane-container">
          <a href="http://customer.io/" target="_blank" rel="noopener noreferrer">
            <svg
              ...
              className="plane"
            >
              <polygon fill="#ff002f" points="72.008,0 274.113,140.173 274.113,301.804 390.796,221.102 601.682,367.302 1131.53,0.223  "/>
              <polygon fill="#78051a" points="1131.53,0.223 274.113,140.173 274.113,301.804 390.796,221.102   "/>
            </svg>
          </a>
        </div>
      </div>
      ...
      <div className="company-details-wraper">
        <div className="company-details-box">
          ...
          <div className="company-details-box-text">
            <h3 className="company-details-box-heading">Our Office Address</h3>
            <p className="company-details-box-p">Nagar Phase 7 Bengaluru 560062 India</p>
          </div>
        </div>
