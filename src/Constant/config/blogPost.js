...
const {technicalWizardryOfOurWebDesignAgencyImage,blogs13Image,strategiesForEffectiveWebDesignByOurAgencyImage,howAgecisPutsYourAudienceFirstInEveryWebsiteProject,ensuresYourWebsiteRisesToTheTopOfSearchRankingsImage} = images;
export const blogPosts = [
    {
      ...
      paragraph: 'Strategies for Effective Web Design by Our Agency. In the dynamic world of web design, where first impressions are currency and user experience reigns supreme, our agency has honed a repertoire of strategies that redefine digital landscapes...',
    ...
    },
    {
      ...
      paragraph: 'UI design is crucial to enhancing user experience. In this post, we explore the best practices for designing intuitive and engaging user interfaces that captivate users...',
