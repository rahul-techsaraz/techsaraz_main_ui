      ...
      <section className="competitor">
        ...
        <div className="competitor-in-box">
          ...
          <p className="competitor-p">
            Why do our clients regard us as the best digital marketing agency in
            Bangalore?
          </p>
          <div className="competitor-in-box-wraper">
            <div className="competitor-box">
              ...
              <p className="competitor-box-p">
                We assign a dedicated project manager for each campaign to
                ensure smooth communication and flawless execution.
              </p>
            </div>
            ...
            <div className="competitor-box">
              ...
              <p className="competitor-box-p">
                We leverage advanced marketing automation tools to increase
                efficiency and enable personalized interactions with your
                customers.
              </p>
            </div>
            ...
            <div className="competitor-box">
              ...
              <p className="competitor-box-p">
                Our strategies focus on delivering the maximum return on your
                investment.
              </p>
            </div>
            ...
            <div className="competitor-box">
              ...
              <h1 className="competitor-box-h1">
                Real-Time Performance Tracking
              </h1>
              <p className="competitor-box-p">
                We believe in total transparency. Our regular reporting and
                performance tracking ensure you're always in the loop about your
                campaign's progress.
              </p>
            </div>
            ...
            <div className="competitor-box">
              ...
              <p className="competitor-box-p">
                We measure our success by your success. Our practices are geared
                towards achieving tangible results that drive your business
                forward.
              </p>
            </div>
          </div>
