  ...
  return (
   <div className="testimonials-section">
    <div className="testimonial-pulse">
        <img src={constants.images.quotesImage.imageURL} alt={constants.images.quotesImage.alt} />
    </div>
	...
	<div className="owl-carousel owl-theme testimonials-container">
    		...
    		<main className="test-card-body">
    			...
    			<p className="testimonial-p">{testimonial.testimonialDescription}</p>
    		...
    		<div className="profile">
    			<div className="profile-image">
    				<img src={testimonial.profileImage.imageUrl} alt={testimonial.profileImage.alt} />
    			</div>
