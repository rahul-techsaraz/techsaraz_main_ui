...
const CounterSection = () => {
  ...
  useEffect(() => {
    incrementCounter(setHappyClients, 445, 15); // Example target value for Happy Clients
    incrementCounter(setCompleteProjects, 518, 18); // Example target value for Complete Projects
