...
const BlogSection = ({blogs}) => {
  ...
  <div className="blog-in-box">
    <div className="blog-heading"><button className="blog-heading-text">NEWS & LATEST UPDATES<span className="blog-span-circle"></span></button></div>
	<div className="blog-heading">
		<h1 className="blog-h1">Our latest news & articles
      from the blog</h1>
              </div>
