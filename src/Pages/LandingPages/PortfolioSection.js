              ...
              <Link to={portfolio.portfolioLink} >
                <div className="horizontal-in-box">
                  <div className="horizontal__num">
                    <img src={portfolio.portfolioImage.imageUrl} alt={portfolio.portfolioImage.alt} />
                    <div className="horizontal-layer-box">{portfolio.companyName}</div>
                    <p className="horizontal-layer-box-p">{portfolio.serviceCategory}</p>
                  </div>
                </div>
                </Link>
              </div>
